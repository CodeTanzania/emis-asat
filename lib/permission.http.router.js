 ...
 * @apiSuccess {String} wildcard System unique identifier of a permission
 ...
 * available i.e additional details that clarify what a permission for
 * @apiSuccess {String} data.wildcard System unique identifier of a permission
 ...
 * @apiUse AuthorizationHeaderErrorExample
 */
router.post(PATH_LIST, function postPermission(request, response, next) {
 ...
 * @apiUse AuthorizationHeaderErrorExample
 */
router.delete(PATH_SINGLE, function deletePermission(request, response, next) {

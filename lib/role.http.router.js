 ...
 * @apiDefine Role Role
 *
 * @apiDescription An entity that defines how a party(ies) acts or, in other
 * words, what roles the party(ies) plays in the context of the
 ...
 * @apiSuccess {String} type Human readable category of a role
 ...
 * of a role
 * @apiSuccess {String} [permissions.resource] Resource constrained by a
 * permission
 * @apiSuccess {String} [permissions.action] Action(or permit)
 * constrained(or granted) by a permission
 * @apiSuccess {String} [permissions.wildcard] System unique identifier of
 * a permission
 ...
 * @apiSuccess {String} data.type Human readable category of a role
 * @apiSuccess {String} data.name Unique human readable name of a role
 * @apiSuccess {String} data.description A brief summary about a role if available
 * i.e additional details that clarify what a role for
 * @apiSuccess {Object} [data.permissions] List of defined permits(access rights)
 * of a role
 * @apiSuccess {String} [data.permissions.resource] Resource constrained by a
 * permission
 * @apiSuccess {String} [data.permissions.action] Action(or permit)
 * constrained(or granted) by a permission
 * @apiSuccess {String} [data.permissions.wildcard] System unique identifier of
 * a permission
 ...
 *   "type": "System",
 *   "name": "Cambridgeshire",
 *   "description": "Est et corporis et harum maiores voluptas et.",
